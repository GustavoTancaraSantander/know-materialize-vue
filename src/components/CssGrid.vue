<template>
    <section >
      ...
      <hr>
        ...
        <div class="row">
            <div class="col s12 green">1</div>
        </div>
        <div class="row">
            <div class="col s6 pink">6</div>
            <div class="col s6 red">6</div>
        </div>
        <div class="row">
            <div class="col s3 orange">3</div>
            <div class="col s6">6</div>
            <div class="col s3 orange">3</div>
        </div>
        <!-- ADD DISPLAY MEDIUM A SMALL DIVICES -->
        <div class="row">
            <div class="col s6 m3 pink">6</div>
            <div class="col s6 m9 red">s6 o m9</div>
        </div>
        <div class="row">
            <div class="col s12 m3 yellow">3</div>
            <div class="col s12 m6 brown">6</div>
            <div class="col s12 m3 red lighten-1">3</div>
        </div>
        <!-- DOCUMENT -->
        <div class="row">
